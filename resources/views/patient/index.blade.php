    ...
    <div class="carousel-inner">
      <div class="carousel-item active ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','dental','ear_nose_and_throat') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
      <div class="carousel-item ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','dental') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
      <div class="carousel-item ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','children') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
      <div class="carousel-item ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','cosmetic') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
      <div class="carousel-item ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','eye') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
      <div class="carousel-item ratio ratio-21x9">
        ...
        <div class="carousel-caption d-none d-md-block" style="margin-top: 30rem;">
          ...
          <a href="{{ route('get_special_clinics','women') }}"><button class="hvr-radial-out">Go To Book</button></a>
        </div>
      </div>
    </div>
